...
export default function AboutPage() {
  return (
    <div className="bg-[#F9F9F9]">
      ...
      {/* ── 1. Hero Banner ── */}
      <section className="relative h-[723px] w-full overflow-hidden">
        <Image
          src="/hero/head1.jpg"
          alt="Cobble studio"
          fill
      ...
      {/* ── 2. Our Story ── */}
      <section
        className="px-[200px] pt-[80px] pb-[40px]"
      ...
      <section className="relative overflow-hidden bg-[#F9F9F9]" style={{ minHeight: 900 }}>
        ...
        <div className="relative mx-auto max-w-[1440px] px-[80px] pt-[60px] pb-[80px]">
      ...
      <section className="relative h-[632px] w-full overflow-hidden">
        <Image
          src="/hero/head2.png"
          alt="Our products"
          fill
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 flex items-center" style={{ paddingLeft: "304.5px" }}>
          <h2
      ...
      {/* ── 5. Product Essence ── */}
      <section className="bg-[#F9F9F9] px-[80px] pt-[80px] pb-[80px]" style={{ overflow: "hidden" }}>
        {/* Section heading */}
        <h2
        ...
        <div className="flex flex-col gap-[80px]">
          {essenceSections.map((section, i) => {
            ...
            return (
              <div
                key={section.title}
                className={`flex gap-[60px] items-center ${isEven ? "" : "flex-row-reverse"}`}
              >
                {/* Text */}
      ...
      <section className="relative h-[522px] w-full overflow-hidden">
        <Image
          src="/hero/head4.jpg"
          alt="Product story"
          fill
      ...
      {/* ── 7. Product Cards ── */}
      <section className="relative bg-[#F9F9F9] px-[80px] py-[80px]">
      ...
      <section className="flex h-[288px] w-full overflow-hidden">
        {journalCategories.map((cat) => (
          ...
          >
            ...
            {/* Label */}
            <div className="absolute inset-0 flex items-center justify-center" style={{ top: 133, bottom: "auto", height: "auto" }}>
              <span
